#!/bin/bash
#SBATCH --job-name=SM05 # nombre para identificar el trabajo. Por defecto es el nombre del script # Autor-SimMall-NumCaso-NumMalla
...
source /share/apps/foamMeshToMED/OpenFOAMv2106/bashrc
export LD_LIBRARY_PATH="/share/apps/foamMeshToMED/OpenFOAMv2106/prerequisites/hdf5/lib":$LD_LIBRARY_PATH
/share/apps/foamMeshToMED/OpenFOAMv2106/foamMeshToMED
