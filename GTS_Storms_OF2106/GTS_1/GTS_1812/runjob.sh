...
decomposePar -decomposeParDict system/decomposeParDict.40
mpirun snappyHexMesh -parallel -overwrite -decomposeParDict system/decomposeParDict.40 -dict system/snappyHexMeshDict > logpart1.snappyHexMesh
#mpirun snappyHexMesh -parallel -overwrite -decomposeParDict system/decomposeParDict.40 -dict system/snappyHexMeshLayersDict > logpart2.snappyHexMesh
reconstructParMesh -mergeTol 1e-6 -constant > log.reconstructPar1
renumberMesh -latestTime > renumberMesh.log
mpirun checkMesh -parallel -decomposeParDict system/decomposeParDict.40 > checkMesh.log
